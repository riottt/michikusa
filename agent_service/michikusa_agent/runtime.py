...
TRACE: dict[str, tuple[str, str, str]] = {
    ...
    "calendar_scout_agent": ("空き時間を探す", "予定から使える時間と帰宅余白を確認します。", "purple"),
    ...
    "route_geometry_agent": ("地図に道を描く", "選んだピンを地図の経路へつなぎます。", "purple"),
    ...
    "calendar_draft_agent": ("時間割にする", "移動と滞在を予定にまとめます。", "purple"),
    ...
    "calendar_auth_agent": ("カレンダー接続を確認", "ユーザーが許可した接続情報を確認します。", "purple"),
    "calendar_container_agent": ("カレンダーを準備", "MICHIKUSA用のカレンダーを選択または作成します。", "green"),
    "calendar_action_agent": ("予定をまとめて登録", "移動、遊び、帰宅をカレンダーへまとめて反映します。", "orange"),
                ...
                if not force_demo and (self.settings.live_gemini_enabled or self.settings.live_maps_enabled):
                    yield {
                        ...
                        "trace": AgentTraceEvent(
                            ...
                            label="近くの候補から案内を続ける",
                            message="接続が不安定なため、近くの候補から案内を続けます。",
                            status="warning",
                            color="orange",
